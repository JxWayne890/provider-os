  ...
  return (
    <div className="space-y-10 animate-reveal pb-20">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-5xl font-serif font-bold text-[#1A1A2E] tracking-tight">Deal flow</h2>
          <p className="text-[#64748B] mt-2 font-medium tracking-wide uppercase text-xs">Tracking active capital deployments and decision timelines</p>
        </div>
        <div className="flex gap-4">
          <button className="flex items-center gap-2 px-6 py-3 bg-white border border-black/5 rounded-2xl text-xs font-bold text-[#1A1A2E] hover:bg-[#F7F8FA] transition-all shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {deals.map((deal) => (
          <div key={deal.id} className="luminous-card bg-white/80 p-6 space-y-6 group hover:translate-y--1 transition-all">
            <div className="flex justify-between items-start">
              <div>
                <h3 className="text-xl font-serif font-bold text-[#1A1A2E] group-hover:text-[#FF9F1C] transition-colors">{deal.offerName}</h3>
            ...
            <div className="pt-6 border-t border-[#F7F8FA] flex items-center justify-between">
              <a
        ...
        {deals.length === 0 && (
          <div className="col-span-full py-32 flex flex-col items-center justify-center text-[#64748B]">
